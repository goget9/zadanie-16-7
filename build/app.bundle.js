...
var _TodoList = __webpack_require__(37);
				...
				this.props.data.map(function (todo) {
					return _react2.default.createElement(
						...
						{ key: todo.id, onClick: function onClick() {
								return _this2.props.remove(todo.id);
							} },
						todo.text
					);
				})
